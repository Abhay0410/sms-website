...
//       <Link to="/modules" className="text-slate-600 font-medium hover:text-indigo-600 transition">Modules</Link>
    ...
    <nav className="px-6 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-50 shadow-sm border-b border-slate-200 flex justify-between items-center">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative group">
          <button className="flex items-center gap-1 text-slate-600 font-medium hover:text-indigo-600 transition">
            Modules
            <ChevronDown size={16} />
          </button>
