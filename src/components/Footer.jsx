...
const modules = [
  ...
  { label: "Admission & Enquiry",  path: "/admission-and-enquiry" },
  { label: "Result Management",    path: "/result-management"   },
  { label: "HR & Payroll",         path: "/hr-payroll"          },
  { label: "Library Management",   path: "/library-management"  },
  { label: "Transport Management", path: "/transport-management" },
  { label: "Inventory & Assets",   path: "/inventory-management" },
