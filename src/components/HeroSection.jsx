...
//     {/* Left Content */}
//     <div>
//       <div className="inline-flex px-4 py-2 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-600 font-semibold text-sm mb-6">
//        ✨ EduZager v2.0 is now live
//       </div>
...
//         <Link
//           to="/register"
//           className="px-8 py-4 rounded-full bg-indigo-600 text-white font-bold"
//         >
//           Start Free Trial
//         </Link>
...
//   <div className="relative  w-full h-[650px] lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl border border-slate-200 bg-white">
...
//     {/* Students Card */}
//     <div className="absolute top-6 -left-8 bg-white rounded-3xl shadow-2xl p-5 w-64 border border-slate-100">
...
//     {/* Attendance Card */}
//     <div className="absolute bottom-10 -right-8 bg-white rounded-3xl shadow-2xl p-5 w-72 border border-slate-100">
//       <h4 className="font-bold text-slate-900">
//         Today's Attendance
//       </h4>
...
//     {/* Floating Badge */}
//     <div className="absolute top-8 right-8 bg-white/95 backdrop-blur-md rounded-full px-5 py-3 shadow-lg border border-slate-200">
